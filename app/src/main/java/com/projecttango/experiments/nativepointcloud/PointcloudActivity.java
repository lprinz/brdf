...
public class PointcloudActivity extends Activity implements OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    newView = new SurfaceView(this);
    // ...and add it, wrapping the full screen size.

    //addContentView( cameraView, new ViewGroup.LayoutParams( 600, 400 ) );
 ...
 // }
  ...
  public void onClick(View v) {
    ...
    case R.id.top_down_button:
      ...
      //LinearLayout linearLayout = (LinearLayout)findViewById(R.id.cam);
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
      ...
      int pixel = imageBitmap.getPixel(0,0);
